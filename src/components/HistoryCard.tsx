...
const HistoryCard = ({ cardData }: { cardData: EducationDataType }) => {
  const item = cardData;
  return (
    <div className="relative min-w-[300px] flex-1 border-0 border-r-4 border-r-muted-foreground px-4 before:absolute before:-right-[10px] before:top-0 before:z-20 before:h-4 before:w-4 before:rounded-full before:border-4 before:border-primary before:bg-foreground before:content-[''] ">
