        ...
        {ServicesData.map((item) => {
          return (
            <div className=" min-w-[300px] flex-1 px-4 ">
              <div className=" my-4 min-h-[200px] overflow-hidden rounded-lg  border border-muted-foreground bg-card-foreground p-8 shadow-sm shadow-secondary ">
                <h5 className="mb-4 font-semibold text-card">{item.title}</h5>
                <p className=" mb-4 text-sm font-normal text-muted-foreground">
                  {item.disc}
                </p>
                <a href="#contact" className="group ms-2">
