...
const Footer = () => {
  ...
  return (
    <footer className=" m-4 flex justify-center rounded-lg  border border-muted-foreground bg-foreground px-3 py-2 shadow-sm shadow-secondary lg:items-center lg:justify-between">
